...
const kpiMapping = {
  'Quality-Assurance': { specialty: "Комп'ютерні науки, системне проєктування та штучний інтелект", depts: ["СП: Кафедра системного проектування", "ШІ: Кафедра штучного інтелекту"] },
  'Frontend': { specialty: "Комп'ютерні науки, системне проєктування та штучний інтелект", depts: ["СП: Кафедра системного проектування", "ШІ: Кафедра штучного інтелекту"] },
  'Backend': { specialty: "Комп'ютерні науки, системне проєктування та штучний інтелект", depts: ["СП: Кафедра системного проектування", "ШІ: Кафедра штучного інтелекту"] },
  'DevOps': { specialty: "Комп'ютерні науки, системне проєктування та штучний інтелект", depts: ["СП: Кафедра системного проектування"] },
  'Data-Science': { specialty: "Системний аналіз", depts: ["ММСА: Кафедра математичних методів системного аналізу", "САТР: Кафедра системного аналізу та теорії рішень"] },
  'Data-Engineering': { specialty: "Системний аналіз", depts: ["ММСА: Кафедра математичних методів системного аналізу"] },
  'Business-Analysis': { specialty: "Системний аналіз", depts: ["САТР: Кафедра системного аналізу та теорії рішень"] },
  'Project-Management': { specialty: "Системний аналіз", depts: ["САТР: Кафедра системного аналізу та теорії рішень"] }
};
      ...
      <Card className="results-card">
        ...
        <div className="winner-section">
          ...
          <div className="kpi-section">
            ...
            <div className="kpi-pill"><strong>{kpiInfo.specialty}</strong></div>
